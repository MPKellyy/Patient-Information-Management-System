...
class Patient:
    ...
    def create_random_patient_data(self):
        ...
        self.set_random_sex()
        self.set_random_firstname()
        self.set_random_lastname()
        ...
        self.set_random_admission_date()
        self.set_random_discharge_date()
    ...
    def parse_database_input(self):
        # TODO: complete this function
        for key in self.data.keys():
            statement = "self.set_" + key + "(" + literal(str(self.data[key])) + ")"
            exec("self.set_" + key + "(" + literal(str(self.data[key])) + ")")
        pass

    def set_random_firstname(self):
    ...
    def set_random_admission_date(self):
    ...
    def set_random_discharge_date(self):
        # note: also impacts 'current status' as of now
